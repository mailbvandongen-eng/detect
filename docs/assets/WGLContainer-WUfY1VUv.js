import{iB as A,bg as M,d9 as at,iX as Ne,iE as le,lx as ee,oH as rt,nM as ce,oI as st,iD as lt,iF as ct,iH as ft,iG as ut,iA as k,mQ as dt,f3 as _t,hq as vt,oJ as ht,aw as H,bE as pe,oK as mt,u as oe,lv as Fe,j as ve,oL as gt,oM as pt,oN as yt,oO as xt,dv as St,dx as Tt,bm as It,oP as N,oQ as Be,iI as ye,bX as bt,bW as Et,oR as xe,A as Ue,iU as Ot,g4 as Se,dH as At,oS as Pt}from"./index-C14TKpKm.js";import{$ as Mt,d as Te,f as Ct,g as Ye,s as z,t as Lt,n as q,e as X,h as Ge}from"./Utils-BUfagF4m.js";import{e as zt,a as te}from"./ProgramTemplate-CTsBBmvj.js";import{h as $}from"./VertexArrayObject-KszG2g6Q.js";import{n as Dt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-CQ-ZztZa.js";import{n as Rt}from"./vec3f32-WCVSSNPR.js";import{e as He,n as Vt}from"./Container-BVbPCZKM.js";import{n as wt}from"./memoryEstimations-BTx5LQ-3.js";import{o as fe}from"./BufferObject-DQgGqim9.js";import{e as Ie}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./featureConversionUtils-DQm1ZICL.js";import{e as be}from"./OptimizedFeature-Bd8m6JDA.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
...
//# sourceMappingURL=WGLContainer-WUfY1VUv.js.map
