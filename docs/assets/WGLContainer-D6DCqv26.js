import{iA as A,bf as M,d8 as at,iW as Ne,iD as le,lw as ee,oG as rt,nL as ce,oH as st,iC as lt,iE as ct,iG as ft,iF as ut,iz as k,mP as dt,f2 as _t,hp as vt,oI as ht,aw as H,bD as ge,oJ as mt,u as oe,lu as Fe,j as ve,oK as pt,oL as gt,oM as yt,oN as xt,du as St,dw as Tt,bl as It,oO as N,oP as Be,iH as ye,bW as bt,bV as Et,oQ as xe,A as Ue,iT as Ot,g3 as Se,dG as At,oR as Pt}from"./index-DbkovvcO.js";import{$ as Mt,d as Te,f as Ct,g as Ye,s as z,t as Lt,n as q,e as X,h as Ge}from"./Utils-SJq4V0gI.js";import{e as zt,a as te}from"./ProgramTemplate-D571q1Tw.js";import{h as $}from"./VertexArrayObject-F8QsNypu.js";import{n as Dt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-DleVMDUR.js";import{n as Rt}from"./vec3f32-WCVSSNPR.js";import{e as He,n as wt}from"./Container-r-PCGJbx.js";import{n as Vt}from"./memoryEstimations-DSYAnDp8.js";import{o as fe}from"./BufferObject-BCMxHyvo.js";import{e as Ie}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./featureConversionUtils-CW2rgBx3.js";import{e as be}from"./OptimizedFeature-CZPOgkwZ.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
...
//# sourceMappingURL=WGLContainer-D6DCqv26.js.map
