import{f as i,P as h,g,V as f,c as w,S as d,h as p}from"./index-2Pl29JSr.js";const s="strandopgangen_cache",u=10080*60*1e3;async function m(){try{const a=localStorage.getItem(s);if(a){const{timestamp:o,data:n}=JSON.parse(a);if(Date.now()-o<u)return console.log(`✓ Strandopgangen loaded from cache (${n.length} locations)`),n}}catch{}const r=`
    [out:json][timeout:30];
...
//# sourceMappingURL=strandopgangenOL-BR2uKp-l.js.map
