import{g as l,f as h,L as d,V as y,c as p,S as f,d as m}from"./index-BAPSxpN1.js";const c="laarzenpaden_cache",u=10080*60*1e3;async function w(){try{const a=localStorage.getItem(c);if(a){const{timestamp:o,data:t}=JSON.parse(a);if(Date.now()-o<u)return console.log(`✓ Laarzenpaden loaded from cache (${t.length} trails)`),t}}catch{}const s=`
    [out:json][timeout:90];
...
//# sourceMappingURL=laarzenpadenOL-DcmyrYGe.js.map
