import{iA as A,Y as M,dc as at,j2 as Ne,iD as le,lE as ee,oO as rt,nT as ce,oP as st,iC as lt,iE as ct,iG as ft,iF as ut,iz as k,mX as dt,fa as _t,hu as vt,oQ as ht,a2 as H,aQ as ge,oR as mt,bD as oe,lC as Fe,Z as ve,oS as pt,oT as gt,oU as yt,oV as xt,dC as St,dE as Tt,a5 as It,oW as N,oX as Be,iH as ye,bb as bt,ba as Et,oY as xe,s as Ue,i$ as Ot,gb as Se,dO as At,oZ as Pt}from"./index-D_n1PKbT.js";import{$ as Mt,d as Te,f as Ct,g as Ye,s as z,t as Lt,n as q,e as X,h as Ge}from"./Utils-Cxle2KtD.js";import{e as zt,a as te}from"./ProgramTemplate-CmSUcVbs.js";import{h as $}from"./VertexArrayObject-BmvheEBC.js";import{n as Dt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-sCQPMEsp.js";import{n as Rt}from"./vec3f32-WCVSSNPR.js";import{e as He,n as Vt}from"./Container-CUKr6VYX.js";import{n as wt}from"./memoryEstimations-DkbAC0HS.js";import{o as fe}from"./BufferObject-DG81aUoM.js";import{e as Ie}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./featureConversionUtils-_c5i65SW.js";import{e as be}from"./OptimizedFeature-BmWLAsgv.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
...
//# sourceMappingURL=WGLContainer-CELHRbog.js.map
