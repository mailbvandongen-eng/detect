import{f as i,P as h,g as f,V as p,c as g,S as w,h as u}from"./index-CZAHsrzm.js";const s="toiletten_cache",d=1440*60*1e3;async function m(){try{const t=localStorage.getItem(s);if(t){const{timestamp:r,data:o}=JSON.parse(t);if(Date.now()-r<d)return console.log(`✓ Toiletten loaded from cache (${o.length} locations)`),o}}catch{}const n=`
    [out:json][timeout:30];
...
//# sourceMappingURL=toilettenOL-B0oSXoOv.js.map
