import{f as p,P as f,g,V as h,c as d,S as y,h as m}from"./index-CdZcVdLJ.js";const i="natuurparkeer_cache",w=1440*60*1e3;async function k(){try{const r=localStorage.getItem(i);if(r){const{timestamp:n,data:a}=JSON.parse(r);if(Date.now()-n<w)return console.log(`✓ Natuurparkeerplaatsen loaded from cache (${a.length} locations)`),a}}catch{}const o=`
    [out:json][timeout:60];
...
//# sourceMappingURL=natuurParkeerOL-BIrELMWm.js.map
