import{B as S,c as b,W as $,e as d,n as x,u as C,U as r,P as I,A as T,C as N,N as g,g as y,X as L}from"./index-oST-G3yW.js";function m(s,e){const o=`
  ...
  `,t={...x(),bandCount:e},a=[];if(s.color!==void 0){const n=d(t,s.color,N);a.push(`color = ${n};`)}if(s.contrast!==void 0){const n=d(t,s.contrast,g);a.push(`color.rgb = clamp((${n} + 1.0) * color.rgb - (${n} / 2.0), vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)}if(s.exposure!==void 0){const n=d(t,s.exposure,g);a.push(`color.rgb = clamp((${n} + 1.0) * color.rgb, vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)}if(s.saturation!==void 0){const n=d(t,s.saturation,g);a.push(`
