import{f as h,P as d,g as p,V as w,c as f,S as g,h as u}from"./index-CdZcVdLJ.js";const i="winkelcentra_cache",m=10080*60*1e3;async function y(){try{const n=localStorage.getItem(i);if(n){const{timestamp:o,data:a}=JSON.parse(n);if(Date.now()-o<m)return console.log(`✓ Winkelcentra loaded from cache (${a.length} locations)`),a}}catch{}const r=`
    [out:json][timeout:60];
...
//# sourceMappingURL=winkelcentraOL-CafFMA-5.js.map
