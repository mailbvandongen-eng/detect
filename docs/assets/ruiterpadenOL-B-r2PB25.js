import{g as l,f as d,L as u,V as p,c as f,S as h,d as y}from"./index-CdZcVdLJ.js";const c="ruiterpaden_cache",m=10080*60*1e3;async function g(){try{const e=localStorage.getItem(c);if(e){const{timestamp:o,data:a}=JSON.parse(e);if(Date.now()-o<m)return console.log(`✓ Ruiterpaden loaded from cache (${a.length} trails)`),a}}catch{}const r=`
    [out:json][timeout:60];
...
//# sourceMappingURL=ruiterpadenOL-B-r2PB25.js.map
