...
return applyOpacity(color);
}`))}const St=me();function ma(a){a.vertex.code.add("#define noPerspectiveWrite(x, w) (x * w)")}function qe(a){a.fragment.code.add("#define noPerspectiveRead(x) (x * gl_FragCoord.w)")}function va(a){return a.pattern.map(e=>Math.round(e*a.pixelRatio))}function ga(a){if(a==null)return 1;const e=va(a);return Math.floor(e.reduce((t,i)=>t+i))}function Sa(a){return a==null?ii:a.length===4?a:ge(ba,a[0],a[1],a[2],1)}const ba=Ze();function _a(a,e){if(!e.stippleEnabled)return void a.fragment.code.add(c`float getStippleAlpha(float lineWidth) { return 1.0; }
...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function Ct(a){const e=a.stipplePattern;return e?ga(a.stipplePattern)/e.pixelRatio:1}const ya=.4,Dt=64,xa=Dt/2,Ta=xa/5,$a=Dt/Ta,ws=.25;function Pa(a,e){const t=a.vertex,i=e.hasScreenSizePerspective;et(t),t.uniforms.get("markerScale")==null&&t.constants.add("markerScale","float",1),t.constants.add("markerSizePerLineWidth","float",$a).code.add(c`
...
return animatedColor;
        ...
        return (exp(-decayRate * x) - cutOff) / (1.0 - cutOff);`;default:return"return 1.0;"}}const Oa=Ze(),Se=1;function At(a){const e=new sa,{attributes:t,varyings:i,vertex:s,fragment:n}=e,{applyMarkerOffset:o,draped:l,output:r,capType:d,stippleEnabled:p,falloffEnabled:g,roundJoins:m,wireframe:u,innerColorEnabled:f,hasAnimation:_,hasScreenSizePerspective:b}=a;n.include(fi),e.include(fa,a),e.include(_a,a),e.include(mi,a),e.include(vi,a),e.include(wa,a);const G=o&&!l;G&&(s.uniforms.add(new q("markerScale",v=>v.markerScale)),e.include(Pa,{space:2,hasScreenSizePerspective:b})),gi(s,a),s.uniforms.add(new Si("inverseProjectionMatrix",v=>v.camera.inverseProjectionMatrix),new bi("nearFar",v=>v.camera.nearFar),new q("miterLimit",v=>v.join!=="miter"?0:v.miterLimit),new _i("viewport",v=>v.camera.fullViewport)),s.constants.add("LARGE_HALF_FLOAT","float",65500),t.add("position","vec3"),t.add("previousDelta","vec4"),t.add("nextDelta","vec4"),t.add("lineParameters","vec2"),t.add("u0","float"),i.add("vColor","vec4"),i.add("vpos","vec3",{invariant:!0}),i.add("vLineDistance","float"),i.add("vLineWidth","float");const X=p;X&&i.add("vLineSizeInv","float");const h=d===2,A=p&&h,R=g||A;R&&i.add("vLineDistanceNorm","float"),h&&(i.add("vSegmentSDF","float"),i.add("vReverseSegmentSDF","float")),s.code.add(c`vec2 perpendicular(vec2 v) {
return vec2(v.y, -v.x);
}
...
vec2(vStippleDistanceLimits.x, 1e34);`)),s.main.add(c`
    ...
    }`),e.fragment.include(yi,a),e.include(xi,a),n.include(Ti),n.main.add(c`discardBySlice(vpos);
