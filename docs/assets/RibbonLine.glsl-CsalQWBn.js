...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function Ct(a){const e=a.stipplePattern;return e?ga(a.stipplePattern)/e.pixelRatio:1}const _a=.4,Dt=64,xa=Dt/2,Ta=xa/5,$a=Dt/Ta,zs=.25;function Pa(a,e){const t=a.vertex,i=e.hasScreenSizePerspective;et(t),t.uniforms.get("markerScale")==null&&t.constants.add("markerScale","float",1),t.constants.add("markerSizePerLineWidth","float",$a).code.add(c`
