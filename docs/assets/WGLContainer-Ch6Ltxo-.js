import{iG as A,bl as M,de as at,j0 as Ne,iJ as le,lC as ee,oM as rt,nR as ce,oN as st,iI as lt,iK as ct,iM as ft,iL as ut,iF as k,mV as dt,f8 as _t,hv as vt,oO as ht,aB as H,bJ as ge,oP as mt,w as oe,lA as Fe,o as ve,oQ as pt,oR as gt,oS as yt,oT as xt,dA as St,dC as Tt,br as It,oU as N,oV as Be,iN as ye,c0 as bt,b$ as Et,oW as xe,K as Ue,iZ as Ot,g9 as Se,dM as At,oX as Pt}from"./index-rTQ1u7hy.js";import{$ as Mt,d as Te,f as Ct,g as Ye,s as z,t as Lt,n as q,e as X,h as Ge}from"./Utils-C0xVeYYs.js";import{e as zt,a as te}from"./ProgramTemplate-D0BLmJ5A.js";import{h as $}from"./VertexArrayObject-CJRBaowx.js";import{n as Dt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-BKmnDWL4.js";import{n as Rt}from"./vec3f32-WCVSSNPR.js";import{e as He,n as Vt}from"./Container-D_xVlRzt.js";import{n as wt}from"./memoryEstimations-lXx9TGBk.js";import{o as fe}from"./BufferObject-D6bkmJe5.js";import{e as Ie}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./featureConversionUtils-BxJVbjnp.js";import{e as be}from"./OptimizedFeature-Ub_uEYf0.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
...
//# sourceMappingURL=WGLContainer-Ch6Ltxo-.js.map
