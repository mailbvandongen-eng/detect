import{iF as A,bk as M,dd as at,i$ as Ne,iI as le,lB as ee,oL as rt,nQ as ce,oM as st,iH as lt,iJ as ct,iL as ft,iK as ut,iE as k,mU as dt,f7 as _t,hu as vt,oN as ht,aA as H,bI as ge,oO as mt,v as oe,lz as Fe,n as ve,oP as pt,oQ as gt,oR as yt,oS as xt,dz as St,dB as Tt,bq as It,oT as N,oU as Be,iM as ye,b$ as bt,b_ as Et,oV as xe,J as Ue,iY as Ot,g8 as Se,dL as At,oW as Pt}from"./index-D7BvpTsV.js";import{$ as Mt,d as Te,f as Ct,g as Ye,s as z,t as Lt,n as X,e as q,h as Ge}from"./Utils-BvK7y_wS.js";import{e as zt,a as te}from"./ProgramTemplate-axs67dW6.js";import{h as $}from"./VertexArrayObject-cLAkM-cz.js";import{n as Dt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-U7gehgdv.js";import{n as Rt}from"./vec3f32-WCVSSNPR.js";import{e as He,n as Vt}from"./Container-DK2Z0Yr2.js";import{n as wt}from"./memoryEstimations-C2KWjYh_.js";import{o as fe}from"./BufferObject-DDf2rota.js";import{e as Ie}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./featureConversionUtils-CvyCv_mM.js";import{e as be}from"./OptimizedFeature-o1if1TgD.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function qe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=qe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:qe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
...
//# sourceMappingURL=WGLContainer-H5kymOAt.js.map
