              ...
              <div className="flex-1 space-y-5 overflow-y-auto p-4">
                <section>
                  <p className="text-sm text-gray-700">
                    De Detect Agent is een <strong>read-only analysehulp</strong>. Hij leest alleen het
                    huidige kaartgebied en de actieve lagen. Hij verandert niets automatisch.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-2 text-sm text-gray-700">
                    ...
                    <div className="flex items-start gap-2">
                      <Sparkles size={16} className="mt-0.5 text-emerald-700" />
                      <span>Gelezen signalen zoals relief, bodem, bekende sites en verstoring</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <Sparkles size={16} className="mt-0.5 text-emerald-700" />
